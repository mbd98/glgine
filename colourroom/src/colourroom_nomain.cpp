...
void colourroom() {
    ...
    //load textures
    GLuint carpetTextureID = loadtext("../colourroom/assets/textures/carpet.png");
    GLuint woodTextureID = loadtext("../colourroom/assets/textures/wood.png");
    GLuint glossTextureID = loadtext("../colourroom/assets/textures/gloss.png");
    GLuint carrotTextureID = loadtext("../colourroom/assets/textures/water.png");

    //Load shaders
    std::string shaderPathPrefix = "../colourroom/assets/shaders/";
    GLuint textureShader = loadSHADER(shaderPathPrefix + "texturevertex.glsl",
                                      shaderPathPrefix + "texturefragment.glsl");
    GLuint shadowShader = loadSHADER(shaderPathPrefix + "shadow_vertex.glsl",
    ...
    do {
        ...
        glm::vec3 lightPosition = glm::vec3(unit * -10.0f, unit * 0.0f, unit *
                                                                        0.0f); //glm::vec3(0.0f,unit*5.0f,unit*30.0f); // the location of the light in 3D space, set light to be 30 units above the origin
        ...
        glm::mat4 lightProjectionMatrix = glm::perspective(85.0f, (float) SHADOW_WIDTH / (float) SHADOW_HEIGHT,
        ...
        glm::mat4 sphereWorldMatrix = glm::translate(glm::mat4(1.0f), glm::vec3(0.0, vertmov, horizmov)) *
                                      glm::translate(glm::mat4(1.0f), glm::vec3(-20.0f * unit, unit * 10.0f, 0.0f)) *
        ...
        glBindVertexArray(cubeAO);
        glm::mat4 cubeWorldMatrix = glm::translate(glm::mat4(1.0f), glm::vec3(0.0, 0.7 * vertmov, 0.7 * horizmov)) *
                                    glm::translate(glm::mat4(1.0f),
                                                   glm::vec3(-22.0f * unit, 10.0f * unit, -6.0f * unit)) *
                                    glm::scale(glm::mat4(1.0f), glm::vec3(2.5f, 2.5f, 2.5f)) *
                                    glm::rotate(glm::mat4(1.0f), glm::radians(30.0f), glm::vec3(1.0f, 0.0f, 1.0f));
        setWorldMatrix(shadowShader, cubeWorldMatrix);
        glDrawArrays(GL_TRIANGLES, 0, 36);

        cubeWorldMatrix = glm::translate(glm::mat4(1.0f), glm::vec3(0.0, 0.7 * vertmov, 0.7 * horizmov)) *
                          glm::translate(glm::mat4(1.0f), glm::vec3(-22.0f * unit, 6.0f * unit, -15.0f * unit)) *
                          glm::scale(glm::mat4(1.0f), glm::vec3(3.5f, 3.5f, 3.5f)) *
                          glm::rotate(glm::mat4(1.0f), glm::radians(40.0f), glm::vec3(0.0f, 1.0f, 1.0f));
        setWorldMatrix(shadowShader, cubeWorldMatrix);
        glDrawArrays(GL_TRIANGLES, 0, 36);

        cubeWorldMatrix = glm::translate(glm::mat4(1.0f), glm::vec3(0.0, 0.7 * vertmov, 0.7 * horizmov)) *
                          glm::translate(glm::mat4(1.0f), glm::vec3(-21.0f * unit, 8.0f * unit, 14.0f * unit)) *
                          glm::scale(glm::mat4(1.0f), glm::vec3(5.5f, 5.5f, 5.5f)) *
                          glm::rotate(glm::mat4(1.0f), glm::radians(40.0f), glm::vec3(0.0f, 1.0f, 1.0f));
        setWorldMatrix(shadowShader, cubeWorldMatrix);
        glDrawArrays(GL_TRIANGLES, 0, 36);
        ...
        sphereWorldMatrix = glm::translate(glm::mat4(1.0f), glm::vec3(0.0, vertmov, horizmov)) *
                            glm::translate(glm::mat4(1.0f), glm::vec3(-20.0f * unit, unit * 10.0f, 0.0f)) *
                            glm::scale(glm::mat4(1.0f), glm::vec3(0.5f, 0.5f, 0.5f));
        ...
        cubeWorldMatrix = glm::translate(glm::mat4(1.0f), glm::vec3(0.0, 0.7 * vertmov, 0.7 * horizmov)) *
                          glm::translate(glm::mat4(1.0f), glm::vec3(-22.0f * unit, 10.0f * unit, -6.0f * unit)) *
                          glm::scale(glm::mat4(1.0f), glm::vec3(2.5f, 2.5f, 2.5f)) *
                          glm::rotate(glm::mat4(1.0f), glm::radians(30.0f), glm::vec3(1.0f, 0.0f, 1.0f));
        ...
        glm::mat4 lensWorldMatrix = glm::translate(glm::mat4(1.0f), glm::vec3(-2.0f * unit, 10.0f * unit, 0.0f)) *
        ...
        lensWorldMatrix = glm::translate(glm::mat4(1.0f), glm::vec3(-1.0f * unit, 10.0f * unit, 0.0f)) *
                          glm::scale(glm::mat4(1.0f), glm::vec3(20.0f, 20.0f, 20.0f)) *
                          glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
        setWorldMatrix(textureShader, lensWorldMatrix);
        if (greenlens) {
        ...
        lensWorldMatrix = glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 10.0f * unit, 0.0f)) *
                          glm::scale(glm::mat4(1.0f), glm::vec3(20.0f, 20.0f, 20.0f)) *
                          glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
        setWorldMatrix(textureShader, lensWorldMatrix);
        if (bluelens) {
